...
public class CandidateSolution implements Cloneable {
	...
	public CandidateAssignment getRandomAssignment() {
		...
		return candidateAssignements.get(keySet.elementAt(PreferenceTable.RND.nextInt(keySet.size())));
	}
	...
	public CandidateSolution clone() {
		try {
			...
			candidateSolution.candidateAssignements = (Hashtable<String, CandidateAssignment>) candidateSolution.candidateAssignements
					.clone();
	...
	public Hashtable<String, CandidateAssignment> GetCandidateAssignements() {
		return this.candidateAssignements;
	}

	public ArrayList<String> getStudentNames() {
		return (ArrayList<String>) this.candidateAssignements.keySet();
	}

	public void addAssignment(CandidateAssignment candidateAssignment) {
